  ...
  return (
    <Box>
      ...
      <form onSubmit={handleTransfer}>
        ...
        <TextField select label="Тип перевода" margin="normal"
          value={data.external}
          onChange={(e) => setData({ ...data, external: e.target.value === 'true' })}
        >
          <MenuItem value="false">Внутренний</MenuItem>
          <MenuItem value="true">Внешний</MenuItem>
        </TextField>
